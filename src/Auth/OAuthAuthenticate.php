...
class OAuthAuthenticate extends BaseAuthenticate
{
     ...
     * @return void
     * @throws \Skeleton\Auth\Exception\InvalidProviderException
     * @throws \Skeleton\Auth\Exception\InvalidSettingsException
     */
     ...
     * @return bool
     * @throws \RuntimeException If the `Skeleton.OAuth2.newUser` event is missing or returns empty.
     */
    ...
    public function getUser(ServerRequest $request)
    {
        ...
        $this->dispatchEvent('Skeleton.OAuth2.afterIdentify', $args);
     ...
     * @return array
     * @throws \Skeleton\Auth\Exception\MissingEventListenerException
     */
