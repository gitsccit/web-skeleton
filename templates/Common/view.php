...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(
            __('Edit ' . \Cake\Utility\Inflector::classify($className)),
            ['action' => 'edit', $entity->id]
        ) ?> </li>
        <li><?= $this->Form->postLink(
            __('Delete ' . \Cake\Utility\Inflector::classify($className)),
        ...
        <?php foreach ($associations as $association) : ?>
            ...
            <li><?= $this->Html->link(
                __("List $associationSpaceDelimited"),
                ['controller' => $association, 'action' => 'index']
            ) ?></li>
            <li><?= $this->Html->link(
                __("New $associationSpaceDelimited"),
                ['controller' => $association, 'action' => 'add']
                ) ?></li>
        <?php endforeach; ?>
    </ul>
</nav>
